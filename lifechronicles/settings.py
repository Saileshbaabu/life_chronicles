# image.png"""
# Django settings for lifechronicles project.
# """
...
ROOT_URLCONF = 'lifechronicles.urls'
...
WSGI_APPLICATION = 'lifechronicles.wsgi.application'
...
# Temporary directory for image uploads
TEMP_DIR = '/tmp'
...
if not DEBUG:
    # Disable SSL redirect for Render (they handle it)
